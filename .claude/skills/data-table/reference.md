...
Template files, naming, imports, and pitfalls for Tenanto list tables.
...
const query = useInfiniteQuery({
  ...
  queryFn: ({ pageParam }) => api.list(propertyId, { ...filters, cursor: pageParam, limit: EXPENSES_LIST_LIMIT }),
