...
import { ReportRevenueExpenseTrendChart } from "@/components/reports/charts/report-revenue-expense-trend-chart";
...
export const ReportChartsSection = memo(({ summary }: ReportChartsSectionProps) => (
  <section aria-label="Report charts" className="space-y-4">
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <ReportRevenueExpenseTrendChart byMonth={summary.byMonth} />
    </div>
    <div className="grid gap-4 lg:grid-cols-2">
