...
export const PropertySettingsForm = memo(
  ({ canEdit, propertyId, settings }: PropertySettingsFormProps) => {
        ...
        <CardContent className="space-y-8 pt-6">
          ...
          {canEdit ? (
            <div className="flex flex-wrap gap-2">
              <Button disabled={!hasChanges || isPending} onClick={handleSave} type="button">
