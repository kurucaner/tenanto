...
import { useDebouncedElementSize } from "@/hooks/use-debounced-element-size";
...
function ChartTooltipContent({
  ...
  const showTopTooltipLabel = payload.length !== 1 || indicator === "dot";
  ...
  return (
    ...
    >
      {showTopTooltipLabel ? tooltipLabel : null}
