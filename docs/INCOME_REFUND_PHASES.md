...
- Partial refunds → see [`INCOME_PARTIAL_REFUND_PHASES.md`](./INCOME_PARTIAL_REFUND_PHASES.md)
...
- Partial refunds — [`INCOME_PARTIAL_REFUND_PHASES.md`](./INCOME_PARTIAL_REFUND_PHASES.md)
- Negative adjustment income line with link to original (alternative model; see partial refund doc)
